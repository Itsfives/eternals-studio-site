  ...
  const allProjects = [
    ...
    },
    {
      ...
      gallery: [
        ...
        "https://assets.zyrosite.com/cdn-cgi/image/format=auto,w=900,h=600,fit=crop/YNqO7k0WyEUyB3w6/midas-for-website-Yyv0nV0WMjCMk3pq.jpg"
      ]
    },
    // 2024 Projects
    {
    ...
    },
    {
      ...
      gallery: [
        ...
        "https://assets.zyrosite.com/cdn-cgi/image/format=auto,w=150,h=144,fit=crop/YNqO7k0WyEUyB3w6/blue-AzGe2BVRWBunJGq0.png",
        "https://assets.zyrosite.com/cdn-cgi/image/format=auto,w=150,h=144,fit=crop/YNqO7k0WyEUyB3w6/bronze-YrDlK8VPGGhJXobo.png",
        "https://assets.zyrosite.com/cdn-cgi/image/format=auto,w=150,h=144,fit=crop/YNqO7k0WyEUyB3w6/gold-Yg2WNoVGMMSVDjW5.png",
        "https://assets.zyrosite.com/cdn-cgi/image/format=auto,w=150,h=144,fit=crop/YNqO7k0WyEUyB3w6/green-ALpnRNrVZOSbr6eB.png",
        "https://assets.zyrosite.com/cdn-cgi/image/format=auto,w=150,h=144,fit=crop/YNqO7k0WyEUyB3w6/multi-color-mk3zboV71KUy7Wge.png",
        "https://assets.zyrosite.com/cdn-cgi/image/format=auto,w=150,h=144,fit=crop/YNqO7k0WyEUyB3w6/silver-AE0oRjKVgXHKWR5D.png",
  ...
  const projects = [
    ...
    },
    {
      ...
      gallery: [
        ...
        "https://assets.zyrosite.com/cdn-cgi/image/format=auto,w=437,h=328,fit=crop/YNqO7k0WyEUyB3w6/midas-white-A1a5kvDQOnCMPJzN.png",
        "https://assets.zyrosite.com/cdn-cgi/image/format=auto,w=709,h=384,fit=crop/YNqO7k0WyEUyB3w6/midas-for-website-Yyv0nV0WMjCMk3pq.jpg",
        "https://assets.zyrosite.com/cdn-cgi/image/format=auto,w=1224,h=400,fit=crop/YNqO7k0WyEUyB3w6/midas-group-logo-text_red-orange-YleQjVaE3RHvBJLX.png"
      ]
    },
    // 2024 Projects
    {
        ...
        <Card className="border border-slate-700 bg-slate-800/95 backdrop-blur-sm shadow-2xl">
          ...
          <CardContent className="px-8 pb-8">
            ...
            <div className="space-y-3">
              ...
              >
                <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12.017 0C8.396 0 8.025.044 8.025.044c-3.783.39-6.893 3.5-7.283 7.283 0 0-.044.371-.044 4.692s.044 4.692.044 4.692c.39 3.783 3.5 6.893 7.283 7.283 0 0 .371.044 4.692.044s4.692-.044 4.692-.044c3.783-.39 6.893-3.5 7.283-7.283 0 0 .044-.371.044-4.692s-.044-4.692-.044-4.692c-.39-3.783-3.5-6.893-7.283-7.283 0 0-.371-.044-4.692-.044zm0 1.441c4.105 0 4.192.019 4.192.019 3.061.32 5.518 2.777 5.838 5.838 0 0 .019.087.019 4.192s-.019 4.192-.019 4.192c-.32 3.061-2.777 5.518-5.838 5.838 0 0-.087.019-4.192.019s-4.192-.019-4.192-.019c-3.061-.32-5.518-2.777-5.838-5.838 0 0-.019-.087-.019-4.192s.019-4.192.019-4.192c.32-3.061 2.777-5.518 5.838-5.838 0 0 .087-.019 4.192-.019z"/>
                  <path d="M15.736 12.017c0-2.321 1.89-4.211 4.211-4.211v-1.46c-3.123 0-5.671 2.548-5.671 5.671h1.46zm-7.454 0c0-2.321-1.89-4.211-4.211-4.211v-1.46c3.123 0 5.671 2.548 5.671 5.671h-1.46z"/>
                </svg>
                Continue with Apple
              </Button>
            </div>
