...
const FloatingElements = () => {
  ...
  const [logos, setLogos] = useState([
    ...
    { id: 4, x: 900, y: 180, size: 'w-6 h-6', opacity: 0.5, delay: 1.5, color: 'violet' },
    { id: 5, x: 1100, y: 280, size: 'w-10 h-10', opacity: 0.9, delay: 2, color: 'seafoam' },
    { id: 6, x: 300, y: 450, size: 'w-8 h-8', opacity: 0.7, delay: 2.5, color: 'violet' },
    { id: 7, x: 800, y: 400, size: 'w-10 h-10', opacity: 0.6, delay: 3, color: 'seafoam' },
    { id: 8, x: 550, y: 500, size: 'w-12 h-12', opacity: 0.8, delay: 3.5, color: 'violet' },
    { id: 9, x: 200, y: 120, size: 'w-8 h-8', opacity: 0.5, delay: 4, color: 'seafoam' },
    { id: 10, x: 750, y: 150, size: 'w-9 h-9', opacity: 0.6, delay: 4.5, color: 'violet' },
    ...
    { id: 13, x: 350, y: 180, size: 'w-8 h-8', opacity: 0.6, delay: 6, color: 'seafoam' },
    { id: 14, x: 1200, y: 380, size: 'w-9 h-9', opacity: 0.7, delay: 6.5, color: 'violet' }
  ]);
...
const PortfolioPage = () => {
  ...
  const ProjectDetailModal = ({ project, isOpen, onClose }) => {
    ...
    const getProjectGallery = (projectId) => {
      // Real project image galleries from the crawled data
      const galleries = {
        1: [ // ULoveWhysper
        ...
        // Add more project galleries as needed
      };
      return galleries[projectId] || [project.image];
    };
    ...
    return (
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto bg-white/95 dark:bg-slate-900/95 backdrop-blur-md">
          <DialogHeader>
            ...
            <DialogDescription className="text-lg text-slate-600 dark:text-slate-400 mt-4">
              {project.description}
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="mt-6">
            ...
            {/* Call to Action */}
            <div className="mt-8 p-6 bg-gradient-to-r from-teal-500/10 to-purple-500/10 dark:from-teal-500/20 dark:to-purple-500/20 rounded-lg border border-teal-200/50 dark:border-teal-700/50">
